"""DMLIV estimation using neural network models."""
...
def dmliv_nn(
    ...
    """Run DMLIV with simple neural networks."""
    if cvs is None:
        cvs = [
            "Inst_invest",
            "Inde_director",
    ...
    est = DMLIV(
        model_y_xw=MLPRegressor(hidden_layer_sizes=(64, 32), max_iter=500),
        model_t_xwz=MLPRegressor(hidden_layer_sizes=(64, 32), max_iter=500),
        model_t_xw=MLPRegressor(hidden_layer_sizes=(64, 32), max_iter=500),
        model_final=MLPRegressor(hidden_layer_sizes=(32,), max_iter=500),
...
if __name__ == "__main__":
    dmliv_nn(x="newsnum", ivs="paper_count")
