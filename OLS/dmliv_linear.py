"""DMLIV estimation with linear models."""
...
def dmliv_linear(
    ...
    """Run DMLIV with default settings."""
    if cvs is None:
        cvs = [
            "Inst_invest",
            "Inde_director",
    ...
    var = np.var(Y, ddof=0)
    r2_outcome = 1 - score / var
    print("R² of CATE model:", r2_outcome)


if __name__ == "__main__":
    dmliv_linear(x="newsnum", ivs="paper_count")
